...
export default function Index() {
    ...
    async function createTrip() {
        try {
            ...
            console.log(dayjs(selectedDates.endsAt?.dateString).toString());
        ...
        <View className="flex-1 items-center justify-center px-5 ">
            ...
            <View className="w-full bg-zinc-900 p-4 rounded-lg my-8 border border-zinc-800">
                ...
                <Button onPress={handleNextStepForm} isLoading={isCreatingTrip}>
                    <Button.Title>
                        {stepForm === StepForm.TRIP_DETAILS ? "Continuar" : "Confimar viagem"}
                    </Button.Title>
            ...
            <Text className="text-zinc-500 font-regular text-center text-base">
                ...
                com nossos <Text className="text-zinc-300 underline">termos de uso</Text> e política de privacidade.
            </Text>
            <Modal
