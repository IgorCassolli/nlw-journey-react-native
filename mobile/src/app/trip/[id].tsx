...
export default function Trip() {
    ...
    const [option, setOptions] = useState<"activity" | "details">("activity");
    ...
    async function handleConfirmAttendance() {
        try {
            ...
            if (!guestName.trim() || !guestEmail.trim()) {
                Alert.alert("Confirmação", "Preencha nome e e-mail para confirmar");
            }
            ...
            >
                <View className="gap-2 my-4">
                    ...
                    <TouchableOpacity onPress={handleRemoveTrip}>
                        <Text className="text-red-400 text-center m-6">Remover viagem</Text>
                    </TouchableOpacity>
                </View>
            </Modal>
